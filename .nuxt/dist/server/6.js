...
/* harmony default export */ var settingsvue_type_script_lang_js_ = ({
  ...
  async mounted() {
    const {
      data
    } = await Object(api_user["b" /* getCurrentUser */])();
    const {
      user
    } = data;
    this.user = user;
  ...
  methods: {
    ...
    async updateSettings() {
      this.disabled = true;
      await Object(api_user["g" /* updateCurrentUser */])({
        user: this.user
      });
      const {
        data
